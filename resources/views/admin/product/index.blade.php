                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        <tr>
                            <th>{{ ++$i }}</th>
                            <td>
                                <img src="{{ asset($product->thumbnail) }}" alt="{{ $product->thumbnail }}" class="img-fluid" style="width: 35px; height: 35px; border-radius: 25%; border: 2px solid #fff;">
                            </td>
                            <td>{{ $product->name }}</td>
                            <td>$ {{ $product->price }}</td>
                            ...
                            <td>
                                @if (Auth::user()->id === $product->user->id)
                                    <a href="{{ route('product_edit', ['id' => $product->id]) }}" class="btn-action btn-edit" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                    ...
                                    <button type="button" class="btn-action btn-del p-0" data-toggle="modal" data-target="#btn_delete_product_{{ $product->id }}" data-placement="bottom" title="Delete">
                                    ...
                                    <div class="modal fade custom-modal" id="btn_delete_product_{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('product_delete', ['id' => $product->id]) }}" class="btn btn-primary btn-reg">
                                                        Yes
                                                    </a>
                                                </div>
                                            </div>
